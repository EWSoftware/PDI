<%@ Page ValidateRequest="False" Language="VB" Inherits="PDIWebDemoVB.VCardDetails" CodeFile="VCardDetails.aspx.vb" %>
				...
				<tr>
					<td>
						<asp:Button ID="btnSave" runat="server" Text="Save" CssClass="btn btn-default"
							ToolTip="Save changes to vCard" /></td>
			...
			<asp:DataGrid ID="dgLabels" runat="server" AutoGenerateColumns="False" UseAccessibleHeader="true"
				...
				<Columns>
					<asp:TemplateColumn HeaderText="Label">
						<ItemTemplate>
							<%# DirectCast(DataBinder.Eval(Container.DataItem, "Value"), String).Replace(
