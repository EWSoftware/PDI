<%@ Page MasterPageFile="~/MasterPage.master" Language="VB" Inherits="PDIWebDemoVB.VTimeZoneTestForm" CodeFile="VTimeZoneTestForm.aspx.vb" %>
				...
				<tr>
					...
					<td>
						<asp:Button ID="btnApplySrc" runat="server" CssClass="btn btn-default"
							Text="Apply" ToolTip="Apply time zone to date/times" /></td>
				</tr>
			</table>
		</div>
	</div>
	...
	<div class="panel panel-info">
		...
		<div class="panel-body">
			...
			<asp:Button ID="btnGetTZs" runat="server" CssClass="btn btn-default" Text="Download All"
				ToolTip="Download the time zone information in iCalendar format" />
		</div>
	</div>
