<%@ Page MasterPageFile="~/MasterPage.master" Language="VB" Inherits="PDIWebDemoVB.CalendarBrowser" CodeFile="CalendarBrowser.aspx.vb" %>
		...
		<tr>
			...
			<td colspan="3">
				...
				<asp:Button ID="btnUpload" runat="server" CssClass="btn btn-default"
					Text="Upload" ToolTip="Upload the file" />&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					...
					<td>
						<asp:Button ID="btnDownload" runat="server" Text="Download" CssClass="btn btn-default"
							ToolTip="Download this calendar" /></td>
				</tr>
			</table>
		</div>
	</div>
