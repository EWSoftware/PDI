...
// parameters.  This one is used to specify the settings for a secondly recurrence pattern.
//
...
{
	/// <summary>
    /// This user control is used to specify the settings for a secondly recurrence pattern
	/// </summary>
    [ToolboxItem(false)]
	internal sealed partial class SecondlyPattern : System.Windows.Forms.UserControl
	{
        #region Constructor
        //=====================================================================
        ...
        {
            if(recurrence.Frequency == RecurFrequency.Secondly)
                recurrence.Interval = (int)udcSeconds.Value;
        }
        ...
        {
            if(recurrence.Frequency == RecurFrequency.Secondly)
                udcSeconds.Value = (recurrence.Interval < 1000) ? recurrence.Interval : 999;
            else
                udcSeconds.Value = 1;
        }
        #endregion
