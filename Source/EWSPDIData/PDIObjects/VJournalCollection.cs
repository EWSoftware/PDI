...
// File    : VJournalCollection.cs
// Author  : Eric Woodruff  (Eric@EWoodruff.us)
// Updated : 01/03/2025
// Note    : Copyright 2004-2025, Eric Woodruff, All rights reserved
//
// This file contains a collection class for VJournal objects
//
...
{
    /// <summary>
    /// A type-safe collection of <see cref="VJournal"/> objects
    /// </summary>
    /// <remarks>The class has a type-safe enumerator</remarks>
    public class VJournalCollection : ExtendedBindingList<VJournal>
    {
        #region Constructors
        //=====================================================================
        ...
        /// <summary>
        /// Construct the collection using a list of <see cref="VJournal"/> objects
        /// </summary>
        /// <param name="journals">The <see cref="IList{T}"/> of journals to add</param>
        public VJournalCollection(IList<VJournal> journals) : base(journals)
        {
        }
        #endregion
        ...
        public VJournal? this[string uniqueId]
        {
            get
            {
        ...
        /// <summary>
        /// This can be used to ensure that all journals in the collection have a unique ID assigned to them
        /// </summary>
        /// <param name="forceNew">If true, a new unique ID is assigned regardless of whether one already exists.
        /// If false and the journals already has a unique ID, it keeps the old one.</param>
        public void AssignUniqueIds(bool forceNew)
        {
            foreach(VJournal j in this)
                j.UniqueId.AssignNewId(forceNew);
        ...
        {
            foreach(VJournal j in this)
                j.UpdateTimeZoneId(oldId, newId);
