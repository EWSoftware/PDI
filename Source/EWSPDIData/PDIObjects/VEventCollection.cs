...
// File    : VEventCollection.cs
// Author  : Eric Woodruff  (Eric@EWoodruff.us)
// Updated : 11/06/2014
// Note    : Copyright 2004-2014, Eric Woodruff, All rights reserved
// Compiler: Microsoft Visual C#
//
// This file contains a collection class for VEvent objects
//
...
{
    /// <summary>
    /// A type-safe collection of <see cref="VEvent"/> objects
    /// </summary>
    /// <remarks>The class has a type-safe enumerator</remarks>
    public class VEventCollection : ExtendedBindingList<VEvent>
    {
        #region Constructors
        //=====================================================================
        ...
        /// <summary>
        /// Construct the collection using a list of <see cref="VEvent"/> objects
        /// </summary>
        /// <param name="events">The <see cref="IList{T}"/> of events to add</param>
        public VEventCollection(IList<VEvent> events) : base(events)
        {
        }
        #endregion
        ...
        public VEvent this[string uniqueId]
        {
            get
            {
        ...
        /// If false and the event already has a unique ID, it keeps the old one.</param>
        public void AssignUniqueIds(bool forceNew)
        {
            foreach(VEvent e in this)
                e.UniqueId.AssignNewId(forceNew);
        ...
        {
            foreach(VEvent e in this)
                e.UpdateTimeZoneId(oldId, newId);
