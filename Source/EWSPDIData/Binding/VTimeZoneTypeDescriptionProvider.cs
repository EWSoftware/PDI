...
// File    : VTimeZoneTypeDescriptionProvider.cs
...
namespace EWSoftware.PDI.Binding
{
    ...
    /// with the <see cref="VTimeZone"/> class.
    /// </summary>
    public class VTimeZoneTypeDescriptionProvider : ChildPropertyTypeDescriptionProvider
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public VTimeZoneTypeDescriptionProvider() : base(typeof(VTimeZone))
        {
        }
    }
}
