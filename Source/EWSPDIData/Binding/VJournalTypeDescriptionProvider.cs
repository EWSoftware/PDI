...
// File    : VJournalTypeDescriptionProvider.cs
...
namespace EWSoftware.PDI.Binding
{
    ...
    /// with the <see cref="VJournal" /> class.
    /// </summary>
    public class VJournalTypeDescriptionProvider : ChildPropertyTypeDescriptionProvider
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public VJournalTypeDescriptionProvider() : base(typeof(VJournal))
        {
        }
    }
}
