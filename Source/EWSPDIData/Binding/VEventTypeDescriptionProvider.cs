...
// File    : VEventTypeDescriptionProvider.cs
...
namespace EWSoftware.PDI.Binding
{
    ...
    /// with the <see cref="VEvent" /> class.
    /// </summary>
    public class VEventTypeDescriptionProvider : ChildPropertyTypeDescriptionProvider
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public VEventTypeDescriptionProvider() : base(typeof(VEvent))
        {
        }
    }
}
