...
// File    : VNoteTypeDescriptionProvider.cs
...
namespace EWSoftware.PDI.Binding
{
    ...
    /// with the <see cref="VNote" /> class.
    /// </summary>
    public class VNoteTypeDescriptionProvider : ChildPropertyTypeDescriptionProvider
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public VNoteTypeDescriptionProvider() : base(typeof(VNote))
        {
        }
    }
}
