...
// File    : VToDoTypeDescriptionProvider.cs
...
namespace EWSoftware.PDI.Binding
{
    ...
    /// with the <see cref="VToDo" /> class.
    /// </summary>
    public class VToDoTypeDescriptionProvider : ChildPropertyTypeDescriptionProvider
    {
        /// <summary>
        /// Constructor
        /// </summary>
        public VToDoTypeDescriptionProvider() : base(typeof(VToDo))
        {
        }
    }
}
