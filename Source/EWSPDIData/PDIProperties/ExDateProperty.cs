...
{
    /// <summary>
    /// This class is used to represent an Exception Date (EXDATE) property of a calendar object that supports
    /// recurrence.
    /// </summary>
    ...
    public class ExDateProperty : BaseDateTimeProperty
    {
        #region Properties
        //=====================================================================
