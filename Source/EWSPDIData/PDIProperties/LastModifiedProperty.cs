...
{
    /// <summary>
    /// This class is used to represent the Last Modified (LAST-MODIFIED) property of a vCalendar or iCalendar
    /// Event or ToDo object.
    /// </summary>
    ...
    public class LastModifiedProperty : BaseDateTimeProperty
    {
        #region Properties
        //=====================================================================
        ...
        {
            LastModifiedProperty o = new LastModifiedProperty();
            o.Clone(this);
            return o;
        }
