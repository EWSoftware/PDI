...
// File    : MinutelyFrequency.cs
// Author  : Eric Woodruff  (Eric@EWoodruff.us)
// Updated : 01/02/2025
// Note    : Copyright 2003-2025, Eric Woodruff, All rights reserved
//
// This file contains a class used to implements the Minutely frequency rules
//
...
{
    /// <summary>
    /// This implements the Minutely frequency rules
    /// </summary>
    internal sealed class MinutelyFrequency : IFrequencyRules
    {
        /// <summary>
        ...
        /// <summary>
        /// This is used to find the next instance of the minutely frequency
        /// </summary>
        /// <param name="r">A reference to the recurrence</param>
        /// <param name="end">The recurrence end date</param>
        /// <param name="to">The end date of the range limiting the instances generated</param>
        ...
        {
            last.AddMinutes(r.Interval);

            if(RecurDateTime.Compare(last, end, RecurDateTime.DateTimePart.Minute) > 0 ||
              RecurDateTime.Compare(last, to, RecurDateTime.DateTimePart.Minute) > 0)
            {
                return false;
            }
        ...
        /// <summary>
        /// This is used to filter the minutely frequency by year day
        /// </summary>
        /// <param name="r">A reference to the recurrence</param>
        /// <param name="dates">A reference to the collection of current instances that have been generated</param>
        /// <returns>The number of instances in the collection.  If zero, subsequent rules don't have to be
        ...
        /// <summary>
        /// This is used to filter the minutely frequency by month day
        /// </summary>
        /// <param name="r">A reference to the recurrence</param>
        /// <param name="dates">A reference to the collection of current instances that have been generated</param>
        /// <returns>The number of instances in the collection.  If zero, subsequent rules don't have to be
        ...
        /// <summary>
        /// This is used to filter the minutely frequency by day of the week
        /// </summary>
        /// <param name="r">A reference to the recurrence</param>
        /// <param name="dates">A reference to the collection of current instances that have been generated</param>
        /// <returns>The number of instances in the collection.  If zero, subsequent rules don't have to be
        ...
        /// <summary>
        /// This is used to filter the minutely frequency by hour
        /// </summary>
        /// <param name="r">A reference to the recurrence</param>
        /// <param name="dates">A reference to the collection of current instances that have been generated</param>
        /// <returns>The number of instances in the collection.  If zero, subsequent rules don't have to be
        ...
        /// <summary>
        /// This is used to filter the minutely frequency by minute
        /// </summary>
        /// <param name="r">A reference to the recurrence</param>
        /// <param name="dates">A reference to the collection of current instances that have been generated</param>
        /// <returns>The number of instances in the collection.  If zero, subsequent rules don't have to be
