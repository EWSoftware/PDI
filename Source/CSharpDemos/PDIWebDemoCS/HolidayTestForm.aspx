<%@ Page MasterPageFile="~/MasterPage.master" Language="c#" Inherits="PDIWebDemoCS.HolidayTestForm" CodeFile="HolidayTestForm.aspx.cs" %>
...
the test search range to a maximum of 50 years from the starting year.</p>
	...
	<div class="panel panel-info">
		...
		<asp:DataGrid ID="dgHolidays" runat="server" AutoGenerateColumns="False"
			...
			OnCancelCommand="dgHolidays_CancelCommand" OnDeleteCommand="dgHolidays_DeleteCommand"
			OnEditCommand="dgHolidays_EditCommand" OnItemCommand="dgHolidays_ItemCommand"
			OnItemDataBound="dgHolidays_ItemDataBound" OnUpdateCommand="dgHolidays_UpdateCommand">
			<Columns>
				<asp:TemplateColumn>
					<ItemTemplate>
						<%# DataBinder.Eval(Container.DataItem, "Description") %>
					(<%# (Container.DataItem as EWSoftware.PDI.FixedHoliday) == null ? "Floating" : "Fixed" %>)
					</ItemTemplate>
					<EditItemTemplate>
							...
							<tr>
								<td colspan="3">
									<asp:Button ID="btnFindHolidays" runat="server"
										...
										ToolTip="Find holidays in the given year range" OnClick="btnFindHolidays_Click" />
									<br /><br />
								</td>
							</tr>
							<tr>
								...
								<td>
									<asp:Button ID="btnIsHoliday" runat="server" Text="Holiday?"
										CssClass="btn btn-default" ToolTip="See if the date specified is a holiday" OnClick="btnIsHoliday_Click" /></td>
							</tr>
							<tr>
							...
							<tr>
								<td>
									<asp:Button ID="btnFindEaster" runat="server"
										...
										ToolTip="Find Easter in the given year range" OnClick="btnFindEaster_Click" /><br />
									<br />
								</td>
							</tr>
