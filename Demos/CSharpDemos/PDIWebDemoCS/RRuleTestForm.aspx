<%@ Page MasterPageFile="~/MasterPage.master" Language="c#" Inherits="PDIWebDemoCS.RRuleTestForm" CodeFile="RRuleTestForm.aspx.cs" %>
	...
	<div class="panel panel-info">
		<div class="panel-body">
			...
			<p><asp:Button ID="btnTestPattern" runat="server" CssClass="btn btn-default"
				Text="Test" ToolTip="Generate instances using pattern" OnClick="btnTestPattern_Click" /></p>
		</div>
				...
				<tr>
					<td colspan="2">
						<asp:Button ID="btnTest" runat="server" CssClass="btn btn-default"
							Text="Test" ToolTip="Generate instances using RRULE" OnClick="btnTest_Click" /></td>
				</tr>
			</table>
		</div>
	</div>
