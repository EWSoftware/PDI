<%@ Page MasterPageFile="~/MasterPage.master" Language="c#" Inherits="PDIWebDemoCS.EventRecurTestForm" CodeFile="EventRecurTestForm.aspx.cs" %>
					...
					<tr>
						<td colspan="2">
							...
							<asp:Button ID="btnTest" runat="server" Text="Test" CssClass="btn btn-default"
								ToolTip="Generate instances" OnClick="btnTest_Click" /></td>
					</tr>
			</table>
		</div>
	</div>
					...
					<td>
						<asp:DataList ID="dlDates" runat="server" EnableViewState="False">
							<ItemTemplate>
								...
								<%# ((EWSoftware.PDI.Duration)DataBinder.Eval(Container.DataItem, "Duration")).ToDescription() %>)
							</ItemTemplate>
						</asp:DataList>&nbsp;</td>
				</tr>
			</table>
